# Day 11 – Advanced Light & Composition

**Genre:** Free choice (apply everything)  
**Time:** Blue hour  
**Locations:** Your favorite from previous days or a new spot.

**Goal:** Attack your weakest skill with one advanced technique, learn RGB channel curves + Calibration, and evolve the recipe to v2.
...
1. Choose one skill that still feels difficult and one advanced track (a/b/c). Focus the entire session on it.
2. Deliver 5 strong images that demonstrate measurable progress on that skill.
3. Volume: at least 60 frames or 30 minutes of active shooting. Note your frame count in reflection.md.
...
*Interactive version of this lesson (with working checklists): https://rcityphotography.com/course/day-11*
