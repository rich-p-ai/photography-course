# Day 09 – Kids & Connection

**Genre:** Portrait  
**Time:** Flexible (soft light preferred; go when the kids are fresh, not when the light is perfect)  
**Locations:** Park, beach, backyard.

**Goal:** Shoot fast-moving genuine moments, keep skin tones natural under mixed light, and learn to version presets instead of overwriting them.
...
1. Target: at least 5 genuine interactions (laughter, concentration, curiosity) — not posed smiles. Note each in reflection.md.
2. Shoot the in-between moments; include context when it adds story.
3. Expect a lower keeper rate today — that’s normal with moving subjects.
...
*Interactive version of this lesson (with working checklists): https://rcityphotography.com/course/day-09*
