# Day 04 – Blue Hour Color & Exposure

**Genre:** Landscape  
**Time:** True blue hour (start 30–45 min before sunrise)  
**Locations:** IOP beach looking east, or Charleston waterfront.

**Goal:** Own manual exposure in fast-changing light, edit blue hour color with intent, and save your first Lightroom preset.
...
1. Bracket exposures when dynamic range is high (sky vs land).
2. Capture the color shift: shoot the same composition every ~5 minutes from deep blue to first light.
3. Constraint: the entire session in full Manual exposure — no Aperture Priority today.
...
*Interactive version of this lesson (with working checklists): https://rcityphotography.com/course/day-04*
