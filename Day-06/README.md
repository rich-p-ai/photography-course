# Day 06 – Reflections & Water

**Genre:** Landscape  
**Time:** Blue hour  
**Locations:** IOP beach, tidal pools, Charleston harbor, puddles after rain.

**Goal:** Go deep on masking — luminance ranges and gradients — and learn the boundary of what presets can and cannot store.
...
1. Low angle for maximum reflection — get the camera near the water surface.
2. Capture both still and slightly moving water versions of the same scene.
3. Shoot at least one abstract: the reflection only, no "real" subject in frame.
