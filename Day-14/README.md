# Day 14 – Style Statement + Portfolio

**Genre:** Final  
**Time:** Blue hour + desk  
**Locations:** One intentional final location of your choosing.

**Goal:** Ship the final set with a consistent grade, write your style statement, and back up your preset system for the next course.
...
1. Shoot one last intentional image that represents where you are now.
2. Finalize the best-of selection (adjust for the outside feedback — or note why you didn’t).
3. Write the 3–5 sentence style statement based on the last two weeks.
...
*Interactive version of this lesson (with working checklists): https://rcityphotography.com/course/day-14*
