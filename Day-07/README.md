# Day 07 – Environmental Portraits (Self / Family)

**Genre:** Portrait  
**Time:** Blue hour or soft morning light  
**Locations:** Home, yard, quiet Charleston street, or IOP dune path.

**Goal:** Handle skin tones with the Color Grading panel, define your personal starting recipe, and save it as Recipe-v1 — the preset you will build on for the rest of the course.
...
1. Self-portraits or family/friends — show the environment, do not crop too tight.
2. Turn the subject to put soft sky light on the face; shoot the same setup from 35mm and 50mm.
3. Direct with actions, not poses: "walk toward me", "look toward the water", "fix your sleeve".
...
*Interactive version of this lesson (with working checklists): https://rcityphotography.com/course/day-07*
