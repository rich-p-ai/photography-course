# Day 10 – Mixed Genre: Portrait in Landscape

**Genre:** Integration  
**Time:** Blue hour  
**Locations:** IOP beach or Charleston waterfront with a person.

**Goal:** Fuse Days 1–3 composition with portrait technique, and learn AI masks + your first adaptive preset.
...
1. One person + strong landscape elements; use leading lines or frames to connect them.
2. Shoot the scale range: tiny figure at 24mm, environmental half-body at 50mm.
3. Balance exposure between person and background — check the histogram, not the screen.
...
*Interactive version of this lesson (with working checklists): https://rcityphotography.com/course/day-10*
