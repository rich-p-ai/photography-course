 ...
 */
const PHOTO_CACHE_VERSION = '20260803a'
...
export const photos: Photo[] = [
  ...
  {
    id: 'night-span',
    title: 'Lights on the Span',
    caption: '',
    location: 'Charleston, SC',
    date: '2026-08-03',
    set: 'Ravenel Geometry',
    category: 'Landscape',
    src: photoSrc('night-span.jpg'),
    width: 1125,
    height: 2000,
  },
  {
  ...
  },
  {
    ...
    set: 'Ravenel Geometry',
    category: 'Landscape',
    src: photoSrc('bridge-asleep.jpg'),
    width: 2000,
    height: 1125,
  },
  {
    id: 'tower-throat',
    title: 'Throat of the Tower',
    caption: '',
    location: 'Charleston, SC',
    date: '2026-08-03',
    set: 'Ravenel Geometry',
    category: 'Landscape',
    src: photoSrc('tower-throat.jpg'),
    width: 1125,
    height: 2000,
  },
  {
    id: 'bridge-curve-runner',
    title: 'Small Figure, Long Curve',
    caption: '',
    location: 'Charleston, SC',
    date: '2026-08-03',
    set: 'Ravenel Geometry',
    category: 'Landscape',
    src: photoSrc('bridge-curve-runner.jpg'),
    width: 2000,
    height: 1125,
  },
  {
    id: 'pair-on-the-path',
    title: 'Side by Side Under Steel',
    caption: '',
    location: 'Charleston, SC',
    date: '2026-08-03',
    set: 'Ravenel Geometry',
    category: 'Landscape',
    src: photoSrc('pair-on-the-path.jpg'),
    width: 1125,
    height: 2000,
  },
  {
    id: 'headphones',
    title: 'Headphones and the Distant Runner',
    caption: '',
    location: 'Charleston, SC',
    date: '2026-08-03',
    set: 'Ravenel Geometry',
    category: 'Landscape',
    src: photoSrc('headphones.jpg'),
    width: 2000,
    height: 1125,
  },
  {
    id: 'hard-lines',
    title: 'Black Kit, Hard Lines',
    caption: '',
    location: 'Charleston, SC',
    date: '2026-08-03',
    set: 'Ravenel Geometry',
    category: 'Landscape',
    src: photoSrc('hard-lines.jpg'),
    width: 1124,
    height: 2000,
  },
  {
    id: 'cable-fan',
    title: 'Bare Chest, Cable Fan',
    caption: '',
    location: 'Charleston, SC',
    date: '2026-08-03',
    set: 'Ravenel Geometry',
    category: 'Landscape',
    src: photoSrc('cable-fan.jpg'),
    width: 1125,
    height: 2000,
  },
