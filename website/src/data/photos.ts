...
export const photos: Photo[] = [
  ...
  // — Morning Battery —
  {
    ...
    set: 'Morning Battery',
    category: 'Landscape',
    src: photoSrc('through-the-wire.jpg'),
    width: 2000,
    height: 1125,
  },
  {
    id: 'scarlet-harbor',
    title: 'Scarlet Harbor',
    caption:
  ...
  },
  {
    ...
    title: 'Statue and Stranger',
    caption: 'The sentinel and a single walker. Scale and silence.',
    location: 'Charleston, SC',
    date: '2026-07-27',
    set: 'Morning Battery',
    category: 'Landscape',
    src: photoSrc('statue-and-stranger.jpg'),
    width: 2000,
    height: 1125,
  },
  {
    ...
    set: 'Morning Battery',
    category: 'Landscape',
    src: photoSrc('the-carrier.jpg'),
    width: 1125,
    height: 2000,
  },
  {
    id: 'iron-against-the-burn',
    title: 'Iron Against the Burn',
    caption: 'Cannon, lamp, and the last hard light of the day.',
    location: 'Charleston, SC',
    date: '2026-07-27',
    set: 'Morning Battery',
    category: 'Landscape',
    src: photoSrc('iron-against-the-burn.jpg'),
    width: 2000,
    height: 1125,
  },
  {
    id: 'black-eyed-dawn',
    title: 'Black-Eyed Dawn',
    caption: 'A wall of black-eyed Susans holding the orange sky.',
    location: 'Charleston, SC',
    date: '2026-07-27',
    set: 'Morning Battery',
    category: 'Landscape',
    src: photoSrc('black-eyed-dawn.jpg'),
    width: 2000,
    height: 1125,
  },
  {
    id: 'low-angle-gold',
    title: 'Low Angle Gold',
    caption: 'Petals and first light. Close and low.',
    location: 'Charleston, SC',
    date: '2026-07-27',
    set: 'Morning Battery',
    category: 'Landscape',
    src: photoSrc('low-angle-gold.jpg'),
    width: 1125,
    height: 2000,
  },
  {
    id: 'violet-under-the-lamps',
    title: 'Violet Under the Lamps',
    caption: 'Gomphrena under sodium and blue hour.',
    location: 'Charleston, SC',
    date: '2026-07-27',
    set: 'Morning Battery',
    category: 'Landscape',
    src: photoSrc('violet-under-the-lamps.jpg'),
    width: 2000,
    height: 1125,
  },
  {
    id: 'sodium-and-salt',
    title: 'Sodium and Salt',
    caption: 'Palm line, path, and the edge of the harbor at the blue hour.',
    location: 'Charleston, SC',
    date: '2026-07-27',
    set: 'Morning Battery',
    category: 'Landscape',
    src: photoSrc('sodium-and-salt.jpg'),
    width: 2000,
    height: 1125,
  },
  {
    ...
    set: 'Morning Battery',
    category: 'Landscape',
    src: photoSrc('the-long-walk-home.jpg'),
    width: 2000,
    height: 1125,
  },
  {
  ...
  // — Charleston Layers (Day 02 framing) —
  {
    id: 'patio-pair',
    title: 'Patio Pair',
    caption:
      'Cocktail blur in the foreground — two figures mid-conversation hold the midground layer.',
    location: 'Charleston, SC',
    date: '2026-07-25',
    day: 2,
    set: 'Charleston Layers',
    category: 'Street',
    src: photoSrc('patio-pair.jpg'),
    width: 576,
    height: 1024,
  },
  {
    ...
    title: 'Bottle Wall',
    caption:
      'Glass shelves as midground subject — cans dissolve in front, patio green softens behind.',
    location: 'Charleston, SC',
    date: '2026-07-25',
    day: 2,
    set: 'Charleston Layers',
    category: 'Street',
    src: photoSrc('bottle-wall.jpg'),
    width: 1024,
    height: 682,
  },
  {
    ...
    title: 'Blue Service',
    caption:
      'Neon garnish tray anchors the counter — bartender motion and blue haze stack behind.',
    location: 'Charleston, SC',
    date: '2026-07-25',
    day: 2,
    set: 'Charleston Layers',
    category: 'Street',
    src: photoSrc('blue-service.jpg'),
    width: 1024,
    height: 576,
  },
  {
    ...
    title: 'Counter Study',
    caption:
      'Patron and menu as foreground — bartender and bottle glow build the depth beyond.',
    location: 'Charleston, SC',
    date: '2026-07-25',
    day: 2,
    set: 'Charleston Layers',
    category: 'Street',
    src: photoSrc('counter-study.jpg'),
    width: 1024,
    height: 576,
  },
  {
    ...
    title: 'Street Pour',
    caption:
      'Iron gate frames a wet cobblestone lane — Bronco and palms hold the far plane.',
    location: 'Charleston, SC',
    date: '2026-07-25',
    day: 2,
    set: 'Charleston Layers',
    category: 'Street',
    src: photoSrc('street-pour.jpg'),
    width: 576,
    height: 1024,
  },
  {
    ...
    title: 'Brim & Crown',
    caption:
      'Round table of caps as the near layer — wall of fedoras fills the room behind.',
    location: 'Charleston, SC',
    date: '2026-07-25',
    day: 2,
    set: 'Charleston Layers',
    category: 'Street',
    src: photoSrc('brim-crown.jpg'),
    width: 1024,
    height: 576,
  },
  ...
  // — Fireside —
  {
    id: 'fireside-1',
    title: 'Fireside I',
    caption: 'Close flame against black. Backyard fire pit.',
    location: 'Backyard, Charleston area',
    date: '2026-07-15',
    set: 'Fireside',
    category: 'Landscape',
