...
export const courseDays: CourseDay[] = [
  ...
  },
  {
    ...
    shootingBrief: [
      ...
      'Edit checklist: 1) Set white balance for blue hour cool tones, 2) Add a luminance range mask to the sky, 3) Apply one color grading move (cool shadows / warm highlights).',
    ],
    uploadNotes: ['Best 3–5 + reflection.md'],
    specialNotes: [],
  },
  {
    ...
    shootingBrief: [
      ...
      'Edit checklist: 1) Increase contrast until subject is pure black, 2) Apply split toning to the sky only, 3) Check silhouette edges are clean at 100% zoom.',
    ],
    uploadNotes: ['Best 3–5 + reflection.md'],
    specialNotes: [],
  },
  {
    ...
    shootingBrief: [
      ...
      'Edit checklist: 1) Mask the water region with a luminance range mask, 2) Boost clarity/texture only in the masked reflection, 3) Compare masked vs. unmasked before exporting.',
    ],
    uploadNotes: ['Best 3–5 + reflection.md'],
    specialNotes: [],
  },
  {
    ...
    studyMaterial: [
      ...
      'Read: Posing and rapport-building basics for directing family/friends in under 60 seconds — L.A. Birdie Photography — Posing Tips for Natural and Joyful Family Photos — https://www.labirdiephotography.com/blog/posing-tips-for-natural-and-joyful-family-photos',
    ],
    shootingBrief: [
      'Self-portraits or family/friends.',
      'Show the environment – do not crop too tight.',
      'Direct soft light onto the face if possible.',
      'Edit checklist: 1) Use Color Grading panel (not Split Toning) for skin midtones, 2) Warm skin slightly vs. cooler background, 3) Check skin tones at 100% zoom before export.',
    ],
    uploadNotes: ['Best 3–5 + reflection.md'],
  ...
  },
  {
    ...
    shootingBrief: [
      ...
      'Edit checklist: 1) Apply luminance range mask to isolate subject from busy street background, 2) Adjust exposure to separate subject from background clutter, 3) Crop for anonymity if consent wasn\'t obtained.',
    ],
    uploadNotes: ['Best 3–5 + reflection.md'],
    specialNotes: [],
  },
  {
    ...
    studyMaterial: [
      ...
      'Read: Building quick rapport with kids before shooting — Jessica Rider Photography — 5 Tips for Authentic Expressions While Photographing Children (genuine expressions in under 5 minutes) — https://www.jessicariderphotography.com/blog/2019/5/16/5-tricks-for-authentic-expressions-while-photographing-children',
    ],
    shootingBrief: [
      'Continuous AF, higher shutter if they move.',
      'Shoot moments between the “poses”.',
      'Include context when it adds to the story.',
      'Edit checklist: 1) Apply a gentle S-curve to fix flat outdoor light, 2) Correct any color cast from mixed shade/sun, 3) Keep skin tones natural — no heavy grading on kids\' portraits.',
    ],
    uploadNotes: [
      'Best 3–5 + reflection.md',
      'In addition to the Day folder + reflection.md, post your top image to one external critique source (subreddit, Discord photography community, or a mentor) and paste their feedback into reflection.md.',
    ],
    specialNotes: [],
  },
  {
    ...
    shootingBrief: [
      ...
      'Edit checklist: 1) Apply range mask to balance person against bright sky, 2) Use a graduated mask on the background only, 3) Confirm subject reads clearly against the landscape at thumbnail size.',
    ],
    uploadNotes: ['Best 3–5 + reflection.md'],
    specialNotes: [],
  },
  {
    ...
    shootingBrief: [
      ...
      'Required constraint: shoot the entire session in full Manual mode (manual exposure AND manual focus) — no Aperture Priority, no AF. This is non-negotiable for today\'s assignment.',
    ],
    uploadNotes: ['Best 3–5 + reflection.md'],
    specialNotes: [],
  },
  {
    ...
    shootingBrief: [
      ...
      'Edit checklist: 1) Choose one consistent split-tone recipe, 2) Apply it to all of today\'s images, 3) Note in reflection.md whether this recipe feels like \'you\'.',
    ],
  ...
  },
  {
    ...
    studyMaterial: [
      ...
      'Compare your Day 1 image against your Day 13 favorites — write 2-3 sentences in reflection.md on what specifically improved.',
    ],
    shootingBrief: [
  ...
  },
  {
    ...
    shootingBrief: [
      ...
      'Edit checklist: 1) Apply your chosen color grade across the full best-of set, 2) Confirm visual consistency across all selected images, 3) Finalize before writing the style statement.',
    ],
    uploadNotes: [
      'Final best image',
      'Style statement',
      'Any remaining reflections',
      'Before finalizing your style statement, get one piece of outside feedback on your best-of selection and note how it did or didn\'t change your final choices.',
    ],
    specialNotes: [
      'Final day.',
