# Day 05 – Silhouettes & Contrast

**Genre:** Landscape / Street  
**Time:** Blue hour into early sunrise  
**Locations:** IOP pier, Charleston Battery, or any strong shape against the sky.

**Goal:** Control exposure for pure shape, learn the Tone Curve, and save a second preset while mastering the save dialog itself.
...
1. Find strong silhouettes: people, trees, architecture, the pier.
2. Keep the horizon clean and level.
3. Shoot both pure and partial silhouettes of the same subject.
...
*Interactive version of this lesson (with working checklists): https://rcityphotography.com/course/day-05*
