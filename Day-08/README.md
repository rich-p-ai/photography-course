# Day 08 – Candid Street Portraits

**Genre:** Street Portrait  
**Time:** Evening golden hour into dusk, or Saturday farmers-market morning — go when people are actually out (blue hour streets are empty)  
**Locations:** Charleston downtown, City Market area, or the farmers market (be respectful and quick).

**Goal:** Photograph strangers with confidence and ethics, and practice the recipe + one tweak editing discipline on difficult backgrounds.
...
## Shooting Brief (30–60 min)

1. Target: at least 8 approaches or interactions (a "no" still counts as an approach). Track yes/no count.
2. Focus on people interacting with the environment — vendors, dog walkers, porch sitters.
3. Mix asked portraits and true candids; note which you prefer shooting.
4. Volume: at least 60 frames or 30 minutes of active shooting. Note your frame count in reflection.md.

## Editing Workflow (Lightroom)
...
*Interactive version of this lesson (with working checklists): https://rcityphotography.com/course/day-08*
