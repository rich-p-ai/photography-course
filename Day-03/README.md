# Day 03 – Perspective & Angles

**Genre:** Street / Landscape  
**Time:** Morning blue hour  
**Locations:** Any Charleston street or IOP beach access.

**Goal:** Render one subject three radically different ways, and learn what Texture, Clarity, and Dehaze actually do (and when they hurt).
...
1. Same scene, three different heights (ground, chest, high).
2. Extreme close + wide context of the same subject.
3. Find at least one vanishing point composition.
...
*Interactive version of this lesson (with working checklists): https://rcityphotography.com/course/day-03*
