# Day 12 – Personal Style Exploration

**Genre:** Whatever feels most like you  
**Time:** Blue hour  
**Locations:** Anywhere you feel drawn to.

**Goal:** Shoot with zero assignment pressure, distill your five best edits into one signature look, and save it as MyStyle-v1.
...
1. Shoot purely for yourself.
2. Note what keeps appearing in your frames — subjects, distances, geometry.
...
*Interactive version of this lesson (with working checklists): https://rcityphotography.com/course/day-12*
